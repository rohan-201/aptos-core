...
use crate::{
    ...
    metrics::TIMER, db_access::{DbAccessUtil, CoinStore, Account, TOTAL_SUPPLY_STATE_KEY},
};
use anyhow::Result;
use aptos_executor::{
...
impl FakeExecutor {
    ...
    fn handle_account_creation(
        ...
        let mut total_supply: u128 = DbAccessUtil::get_value(&TOTAL_SUPPLY_STATE_KEY, state_view)?.unwrap();
